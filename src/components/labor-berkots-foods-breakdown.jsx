...
const data = [
    { name: "Meat", greenbar: 300, whitebar: 300 },
    { name: "Deli", yellowbar: 500, whitebar: 480 },
    { name: "Grocery", greenbar: 300, whitebar: 300 },
    { name: "Nat", greenbar: 700, whitebar: 400 },
    { name: "Frozen", greenbar: 400, whitebar: 600 },
    { name: "Seafood", yellowbar: 400, whitebar: 600 },
    {name:"Dairy",greenbar: 300, whitebar: 300 }
   
  ]

const LaborBerkotFoodsBreakdown = () => {
...
<div>
          <div className="labor-wages-container">
            <div className="labor-wages-tittle-container">
              <span className="labor-wages-tittle">BERKOTS SUPER FOODS #100 OVERAGES BREAKDOWN</span>
              <h2 style={{ fontWeight: "bolder" }}>215.00 HOURS</h2>
...
export default LaborBerkotFoodsBreakdown;