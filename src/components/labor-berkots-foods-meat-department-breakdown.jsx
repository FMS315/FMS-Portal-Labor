...
const data = [
    { name: "Mon 1/17", greenbar: 300, whitebar: 300 },
    { name: "Tue 1/18", yellowbar: 500, whitebar: 480 },
    { name: "Wed 1/19", greenbar: 300, whitebar: 300 },
    { name: "Thurs 1/20", greenbar: 700, whitebar: 400 },
    { name: "Fri 1/21", greenbar: 400, whitebar: 600 },
    { name: "Sat 1/22", yellowbar: 400, whitebar: 600 },
    {name:"Sun 1/23",greenbar: 300, whitebar: 300 }
   
  ]

const LaborBerkotsFoodsMeatDepartmentBreakdown = ()=>{
    return(
        <div>
<div>
          <div className="labor-wages-container">
            <div className="labor-wages-tittle-container">
              <span className="labor-wages-tittle">BERKOTS SUPER FOODS #100 MEAT DEPT OVERAGES BREAKDOWN</span>
              <h2 style={{ fontWeight: "bolder" }}>45.00 </h2>
...
export default LaborBerkotsFoodsMeatDepartmentBreakdown;
