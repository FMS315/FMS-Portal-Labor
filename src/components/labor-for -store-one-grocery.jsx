...
import LaborSalesPerManStoreOneGrocery from "./labor- sales-per-man-storeone-grocery";
import LaborWagesTotalSalesStoreOneGrocery from "./labor-wages-total-sale-storeone-grocery";
...
const LaborForStoreOneGrocery = () => {
    return(
        <div>
        <div>
          <h5 style={{fontWeight:"bolder"}}>Labor for Store 1 Grocery</h5>
        </div>
        <div style={{display:"flex", direction:"row"}}>
       <FaHome style={{paddingTop:5,fontSize:15}} />
       <h6> <FaGreaterThan style={{fontWeight:100,fontSize:15,paddingLeft:8}} /> Labor <FaGreaterThan style={{fontWeight:100,fontSize:15,paddingLeft:8}} />Store 1 <FaGreaterThan style={{fontWeight:100,fontSize:15,paddingLeft:8}} />Grocery</h6>
        </div>
        <div style={{ display: "flex", direction: "row" }}>
          <div className="labor-salespercustomer-card">
          <LaborSalesPerManStoreOneGrocery />
          </div>
          <div style={{ paddingLeft: 25 }}>
            <div className="labor-wagestotolsale-card">
         <LaborWagesTotalSalesStoreOneGrocery />
            </div>
          </div>
        </div>
              ...
              <div>
                <table>
                  ...
                  <tr>
                      ...
                      <th className="labor-table-header">PREVIOUS WEEK </th>
                      <th className="labor-table-header">WEEK ENDING  09/24</th>
                      <th className="labor-table-header">WEEK ENDING 09/17</th>
                      <th className="labor-table-header">WEEK ENDING 09/10</th>
                      <th className="labor-table-header">WEEK ENDING 09/20</th>
                    </tr>
                  </thead>
                  <tbody>
...
export default LaborForStoreOneGrocery;