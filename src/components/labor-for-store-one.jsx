...
import LaborForStoreOneGrocery from "./labor-for -store-one-grocery";
import LaborSalesPerMan from "./labor-sales-per-man";
import LaborSalesPerManStoreOne from "./labor-sales-per-man-storeone";
import LaborWagesTotalSales from "./labor-wages-total-sale";
import LaborWagesTotalSalesStoreOne from "./labor-wages-total-sale-storeone";
...
const LaborForStoreOne = () =>{
   const navigate = useNavigate();


    const openLaborStoreonegrocery = () => {
    navigate("/labor/laborstore1grocery");
...
<div>
        <div>
          <div>
            <h5 style={{fontWeight:"bolder"}}>Labor for Store 1</h5>
          </div>
          <div style={{display:"flex", direction:"row"}}>
         <FaHome style={{paddingTop:5,fontSize:15}} />
         <h6> <FaGreaterThan style={{fontWeight:100,fontSize:15,paddingLeft:8}} /> Labor <FaGreaterThan style={{fontWeight:100,fontSize:15,paddingLeft:8}} />Store 1</h6>
          </div>
          <div style={{ display: "flex", direction: "row" }}>
            <div className="labor-salespercustomer-card">
             <LaborSalesPerManStoreOne />
            </div>
            <div style={{ paddingLeft: 25 }}>
              <div className="labor-wagestotolsale-card">
            <LaborWagesTotalSalesStoreOne />
              </div>
            </div>
          </div>
                ...
                <div>
                  <table>
                    ...
                    <tr>
                        ...
                        <th  className="labor-table-header"onClick={openLaborStoreonegrocery}>GROCERY</th>
...
export default LaborForStoreOne;