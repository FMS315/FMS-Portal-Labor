...
const LaborHourHistory = () => {
    return(
        <div>
<div className="labor-wages-container">
            <div className="labor-wages-tittle-container">
              <span style={{ fontWeight: "bolder" }}>LABOR HOUR HISTORY FOR ALL STORES</span>
              <h2 style={{ fontWeight: "bolder" }}>415.50 HOURS</h2>
...
export default LaborHourHistory;