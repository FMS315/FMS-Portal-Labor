...
import LaborWagesTodayInsight from "./labor-wages-total-sale-today-insights";
  ...
  return (
    <div>
        <div>
         ...
         <h6> <FaGreaterThan style={{fontWeight:100,fontSize:15,paddingLeft:8}} /> Labor</h6>
         <span style={{fontSize:16,fontWeight:"bolder",paddingLeft:300}}>All types of hours?</span>
          </div>
          <div style={{ display: "flex", direction: "row" }}>
            <div className="labor-toal-insights-card">
             {/* <LaborSalesPerMan /> */}
             <LaborTodayInsights />
            </div>
                  ...
                  <table>
                    <thead>
                      <tr>
                        ...
                        <th className="labor-table-header"onClick={LaborForStoreone} >STORE1</th>
                        <th className="labor-table-header">STORE2</th>
                        <th className="labor-table-header">STORE3</th>
                        <th className="labor-table-header">STORE4</th>
                        <th className="labor-table-header">STORE5</th>
                      </tr>
                    </thead>
                    <tbody>
...
export default LaborForTodayInsight;